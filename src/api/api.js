...
export const AllStatusApi = params => { return Vue.http.post('/crm/api/all_status', params, formatData).then(res => res.data) }
export const AllSourceApi = params => { return Vue.http.post('/crm/api/all_source', params, formatData).then(res => res.data) }
export const AllAdminApi = params => { return Vue.http.post('/crm/api/all_admin', params, formatData).then(res => res.data) }
export const AllDepartmentApi = params => { return Vue.http.post('/crm/api/all_department', params, formatData).then(res => res.data) }
